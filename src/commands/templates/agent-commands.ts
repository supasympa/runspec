export const agentCommands = (): Record<string, string> => ({
	interview: `---
description: Interview the stakeholder and draft scenarios
---
Talk with me about the business area we are modelling. Ask one question at a time: what exists, what can happen, what must hold. Surface the awkward cases nobody mentions. Do not write any document.
...
---
Draft or update the domain model from the approved scenarios in scenarios/ and our conversation. Types for what exists, functions for what holds. Keep the model free of framework and I/O concerns.
...
---
Generate one test per approved scenario. Each test file or block carries a \`runspec: S-NN\` marker comment in this project's comment syntax. Assert exactly what the scenario says and nothing else. Do not write tests for unapproved scenarios.
